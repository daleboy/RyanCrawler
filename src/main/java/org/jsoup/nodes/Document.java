...
public class Document extends Element {
	...
	public Elements absLinks() {
		return this.getAllElements().absLinks();
	}
	...
	public Elements links() {
		return this.getAllElements().links();
	}
	...
	/**
	 * Sets the charset used in this document. This method is equivalent to
	 ...
	 * 
	 * @param update
	 *            If <tt>true</tt> the element updated on charset changes,
	 *            <tt>false</tt> if not
	 * 
