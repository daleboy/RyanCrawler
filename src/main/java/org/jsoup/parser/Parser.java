...
public class Parser {
    ...
    /***
     * Parse a fragment of Plain Text or HTML snippet into the document that does not contain a body
     * @param html
     * 				Plain Text or HTML
     * @return element
     */
	public static Element parseOnlyText(String html) {
		return new Document("").append(html);
	}
     ...
     */
	public static Document parseNotContainBody(String html) {
		return Document.creatNotContainBody(html);
	}
